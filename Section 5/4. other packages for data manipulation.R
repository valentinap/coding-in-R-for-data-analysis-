...
# we use the melt() function to reorganise the dataset around the variables 'Months' and 'Days', with the argument id.vars

df_m <- melt(airquality, id.vars = c("Month", "Day"), measure.vars = c("Ozone", "Wind"))


# let's visualise the first cases
...
# we use the dcast() function to reorganise the data
